...
| TC-005 | FR-006 | the landing footer | it renders | one *Contacts* group holding the three messengers built from the phone plus one working link per `kind: "link"` entry in `owner.contacts`; no second copy of those icons anywhere on the page |
